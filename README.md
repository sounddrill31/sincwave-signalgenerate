...
Now copy over the contents of the codegen/lib/genSincLogic/ folder to input/ folder. We assume the project name is genSincLogic, please edit pixi.toml and README.md files to change this.
