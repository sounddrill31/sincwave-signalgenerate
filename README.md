...
Now copy over the contents of the codegen/lib/genSincWave/ folder to input/ folder. We assume the project name is genSincWave, please edit pixi.toml and README.md files to change this.
